...
class RestoreRegistrationPasswordField extends StatefulWidget {
  const RestoreRegistrationPasswordField({
    Key? key,
  }) : super(key: key);

  @override
  _RestoreRegistrationPasswordFieldState createState() =>
      _RestoreRegistrationPasswordFieldState();
}

class _RestoreRegistrationPasswordFieldState
    extends State<RestoreRegistrationPasswordField> {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelText: AppLocalizations.of(context)!.createNewPassword,
